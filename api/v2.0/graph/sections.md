...
Retrieve a list of all **[Sections](../models/external/section)**.
...
Retrieve information about a specific **[Section](../models/external/section)**.
...
### *GET* https://ed.link/api/v2/graph/sections/:section\_id/enrollments

Retrieve a list of **[Enrollments](../models/external/enrollment)** associated with the
specified **[Section](../models/external/section)**.
...
```javascript
axios.get('https://ed.link/api/v2/graph/sections/00000000-0000-0000-0000-000000000000/enrollments', {
	headers: {
		authorization: `Bearer ${integration_access_token}`
	}
});
...
### *GET* https://ed.link/api/v2/graph/sections/:section\_id/people
...
```javascript
axios.get('https://ed.link/api/v2/graph/sections/00000000-0000-0000-0000-000000000000/people', {
	headers: {
		authorization: `Bearer ${integration_access_token}`
	}
});
...
### *GET* https://ed.link/api/v2/graph/sections/:section\_id/teachers
...
```javascript
axios.get('https://ed.link/api/v2/graph/sections/00000000-0000-0000-0000-000000000000/teachers', {
	headers: {
		authorization: `Bearer ${integration_access_token}`
	}
});
...
### *GET* https://ed.link/api/v2/graph/sections/:section\_id/students
...
```javascript
axios.get('https://ed.link/api/v2/graph/sections/00000000-0000-0000-0000-000000000000/students', {
	headers: {
		authorization: `Bearer ${integration_access_token}`
	}
});
